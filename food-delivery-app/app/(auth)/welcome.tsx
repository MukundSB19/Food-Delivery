          ...
          <SafeAreaView className="h-full ">
            <View className="flex flex-col justify-between h-screen ">
              <View className="flex items-end ">
                <TouchableOpacity className="px-2 py-2 m-3 border bg-white/10 border-white/30 rounded-xl backdrop-blur-2xl">
              ...
              <View className="h-2/4 ">
                ...
                <Text className="p-2 mt-4 text-base tracking-tighter font-boldFont text-fontPrimary-0 ml-7">Green Basket brings you fresh organic and locally-sourced produce, making it simple to shop for high-quality fruits,vegetables, dairy and pantry staples.</Text>
                <View className="flex items-center mt-9 ">
              <CustomButton title="Get Started" disabled = {false} />
              </View>
              </View>
            </View>
          </SafeAreaView>
